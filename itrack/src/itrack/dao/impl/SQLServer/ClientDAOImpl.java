package itrack.dao.impl.SQLServer;
...
import itrack.dao.entity.SQLServer.RegionMS;
import itrack.dao.impl.BaseDAOMS;
import itrack.utility.loggerLocal;
...
public class ClientDAOImpl extends BaseDAOMS<ClientsMS> {
	...
	public List<ClientsMS> getClientByPinyin(String pinyin){
		...
		return this.getClientsByCriteria(criteria);
